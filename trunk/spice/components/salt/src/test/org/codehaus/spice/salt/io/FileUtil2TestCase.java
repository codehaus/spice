    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        final PathMatcher matcher = new PathMatcher( new String[]{"**/*.txt"},
                                                     new String[ 0 ] );
    ...
    {
        assertEquals(
            "Check if '" + input + "' normalized to '" + expected + "'",
        ...
        throws Exception
    {
        ...
        assertTrue( "File inexistent ",
                    FileUtil.contentEquals( inexistent, inexistent ) );
        assertTrue( "!inexistent.exists()",
                    !FileUtil.contentEquals( file, inexistent ) );
        assertTrue( "!inexistent.exists()",
                    !FileUtil.contentEquals( inexistent, file ) );
        ...
        throws Exception
    {
        ...
        assertNull( "URL to File",
                    FileUtil.toFile( new URL( "http://somedomain.tld/path" ) ) );
    }
    ...
    public void testRemoveExtension()
        throws Exception
    {
        assertEquals( "Remove extension",
                      "foo",
                      FileUtil.removeExtension( "foo.txt" ) );
        assertEquals( "Remove extension",
                      "a/b/c",
                      FileUtil.removeExtension( "a/b/c.jpg" ) );
        assertEquals( "Remove extension",
                      "a/b/c",
                      FileUtil.removeExtension( "a/b/c" ) );
    }

    public void testGetExtension()
        throws Exception
    {
        assertEquals( "Get extension",
                      "txt",
                      FileUtil.getExtension( "foo.txt" ) );
        assertEquals( "Get extension",
                      "jpg",
                      FileUtil.getExtension( "a/b/c.jpg" ) );
