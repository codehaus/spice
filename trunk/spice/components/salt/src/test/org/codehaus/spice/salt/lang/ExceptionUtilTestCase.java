    ...
    extends TestCase
{
    ...
    private static final String TRACE1_LINE1 = "org.codehaus.spice.salt.lang.MockThrowable: s1";
    ...
    private static final String TRACE2_LINE1 = "org.codehaus.spice.salt.lang.MockThrowable: s2";
    ...
    private static final String TRACE3_LINE1 = "org.codehaus.spice.salt.lang.MockThrowable: s2";
    ...
    {
        final MockThrowable throwable = new MockThrowable( "s1",
                                                           null,
                                                           TRACE1 );
    ...
    {
        final MockThrowable throwable2 = new MockThrowable( "s2",
                                                            null,
                                                            TRACE2 );
        final MockThrowable throwable = new MockThrowable( "s1",
                                                           throwable2,
        ...
        assertEquals( "getCause",
                      throwable2,
                      ExceptionUtil.getCause( throwable ) );
    }

    public void testRetrievalOfCauseManyLevelsDeep()
    {
        final MockThrowable throwable3 = new MockThrowable( "s3",
                                                            null,
                                                            TRACE3 );
        final MockThrowable throwable2 = new MockThrowable( "s2",
                                                            throwable3,
    ...
    public void testPrintStackTraceOnOneLevelDeepException()
    {
        ...
        final MockThrowable throwable = new MockThrowable( "s1",
                                                           ...
                                                           TRACE1 );
        final String trace = ExceptionUtil.printStackTrace( throwable );
        assertEquals( "printStackTrace",
                      TRACE1 + ExceptionUtil.SEPARATOR + TRACE2,
                      trace );
    }
    ...
    public void testPrintStackTraceOnManyLevelDeepException()
    {
        ...
        final MockThrowable throwable = new MockThrowable( "s1",
                                                           ...
                                                           TRACE1 );
        final String trace = ExceptionUtil.printStackTrace( throwable );
        assertEquals( "printStackTrace", TRACE1 +
    ...
    public void testPrintStackTraceWithLowerLimitOnLeafException()
    {
        ...
        final String trace = ExceptionUtil.printStackTrace( throwable,
                                                            ...
                                                            true );
        assertEquals( "printStackTrace",
                      TRACE1_LINE1 + NL + TRACE1_LINE2 + NL,
                      trace );
    }
    ...
    public void testPrintStackTraceWithLowerLimitOnManyLevelDeepException()
    {
        ...
        final String trace = ExceptionUtil.printStackTrace( throwable,
                                                            2,
                                                            true );
        assertEquals( "printStackTrace", TRACE1_LINE1 +
                                         NL +
                                         TRACE1_LINE2 +
                                         NL +
                                         ExceptionUtil.SEPARATOR +
