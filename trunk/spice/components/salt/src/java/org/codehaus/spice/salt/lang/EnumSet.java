 ...
 *
 * <p>The Class has factory methods that will allow the user to scan a Class and
 ...
 * the name of the constant. Consider the example;</p>
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>The above example will create two EnumSets for the class. The first
 * EnumSet includes the enums {NOCLIP=0,BACK=1,FRONT=2} and the seconds includes
 * the enums {SIN=0,COS=1,MOD=2}</p>
 *
 * @author Peter Donald
 */
public final class EnumSet
{
    ...
    /**
     * Create an EnumSet for specified Class including all integer constants. A
     * shortcut for <tt>createFrom( clazz, "(.*)" )</tt>.
     *
     ...
     * that match specified pattern. A shortcut for <tt>createFrom( clazz,
     * "(.*)", true )</tt>.
     *
     * @param clazz the class to extract constants from
    ...
    /**
     * Create an EnumSet for specified Class including all integer constants
     * that match specified pattern and scanning superclass if deep is true.
     *
     * @param clazz the class to extract constants from
     * @param patternString the pattern that constants must match
    ...
    /**
     * Return the fields for specified Class. If deep is true then it will
     * return all the fields of the class, including fields defined in
     * super-classes, otherwise it will just return the fields declared in
     * specified class.
     *
