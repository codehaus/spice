...
public final class EndianUtil
{
    ...
    public static float swapFloat( final float value )
    {
        return Float.intBitsToFloat(
            swapInteger( Float.floatToIntBits( value ) ) );
    }

    public static double swapDouble( final double value )
    {
        return Double.longBitsToDouble(
            swapLong( Double.doubleToLongBits( value ) ) );
    }

    public static void writeSwappedShort( final byte[] data,
                                          final int offset,
                                          final short value )
    {
    ...
    public static void writeSwappedUnsignedShort( final byte[] data,
                                                  final int offset,
                                                  final int value )
    {
        data[ offset + 0 ] = (byte)( ( value >> 0 ) & 0xff );
    ...
    public static short readSwappedShort( final byte[] data,
                                          final int offset )
    {
        return (short)(
    ...
    public static void writeSwappedUnsignedInteger( final byte[] data,
                                                    final int offset,
                                                    final long value )
    {
        data[ offset + 0 ] = (byte)( ( value >> 0 ) & 0xff );
    ...
    public static void writeSwappedInteger( final byte[] data,
                                            final int offset,
                                            final int value )
    {
        data[ offset + 0 ] = (byte)( ( value >> 0 ) & 0xff );
    ...
    public static int readSwappedInteger( final byte[] data,
                                          final int offset )
    {
        return (
                   ( ( data[ offset + 0 ] & 0xff ) << 0 ) +
    ...
    public static void writeSwappedLong( final byte[] data,
                                         final int offset,
                                         final long value )
    {
        data[ offset + 0 ] = (byte)( ( value >> 0 ) & 0xff );
    ...
    public static void writeSwappedFloat( final byte[] data,
                                          final int offset,
                                          final float value )
    {
    ...
    public static float readSwappedFloat( final byte[] data,
                                          final int offset )
    {
        return Float.intBitsToFloat( readSwappedInteger( data, offset ) );
    }

    public static void writeSwappedDouble( final byte[] data,
                                           final int offset,
                                           final double value )
    {
    ...
    public static double readSwappedDouble( final byte[] data,
                                            final int offset )
    {
    ...
    public static void writeSwappedUnsignedShort( final OutputStream output,
                                                  final int value )
        throws IOException
    {
        output.write( (byte)( ( value >> 0 ) & 0xff ) );
    ...
    public static void writeSwappedUnsignedInteger( final OutputStream output,
                                                    final long value )
        throws IOException
    {
        output.write( (byte)( ( value >> 0 ) & 0xff ) );
