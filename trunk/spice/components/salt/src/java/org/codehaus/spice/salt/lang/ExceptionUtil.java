...
{
    /**
     * Constant that used to separate causes when recursively printing
     * exceptions. Matches JDK1.4s separator.
     */
    ...
    /**
     * Constant for separator string printed out during pretty exception
     * printing.
     */
    ...
    /**
     * Generate string for specified exception and the cause of this exception
     * (if any).
     *
    ...
    /**
     * Generate string for specified exception and if printCause is true will
     * print all exception that caused this exception (if any).
     *
     * @param throwable a <code>Throwable</code>
     ...
     * @param printCause if <code>true</code> will print the causes of all
     * exceptions
     * @return the stack trace as a <code>String</code>
     */
    public static String printStackTrace( final Throwable throwable,
    ...
    /**
     * Pretty print the stack trace. This involves printing out the message from
     * each exception in chain and then printing the stack trace of the root
     * cause up untile the stop line.
     *
                                                ...
                                                final String stopLine )
    {
        ...
        while( null != element && root != element )
        {
    ...
    /**
     * Captures the stack trace associated with this exception. The stack trace
     * terminates at any line containing the contents of "stopLine".
     *
     * @param throwable a <code>Throwable</code>
    ...
    /**
     * Serialize the specified <code>Throwable</code> to a string. Restrict the
     * number of frames printed out to the specified depth. If the depth
     * specified is <code>0</code> then all the frames are converted into a
     * string.
     *
     * @param throwable a <code>Throwable</code>
     * @param depth number of stack trace frames to show
