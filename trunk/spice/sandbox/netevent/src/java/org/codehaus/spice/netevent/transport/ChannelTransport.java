 ...
 * 
 * @author Peter Donald
 * @version $Revision: 1.26 $ $Date: 2004-05-17 06:21:39 $
 */
public class ChannelTransport
{
                             ...
                             final EventSink sink )
    {
        ...
        m_inputStream = new MultiBufferInputStream( bufferManager, this, sink );
        m_outputStream = new TransportOutputStream( bufferManager, this, sink, 1024 * 8 );
    }
    ...
    {
        return "[TransportID=" + getId() + ", channel=" + String.valueOf( getChannel() ) + " UserData=" + getUserData() +
               "]";
    }
}
