...
public class TypeIOUtil
{
    ...
    public static void writeInteger( final OutputStream output,
    ...
    public static long readLong( final InputStream input ) throws IOException
    {
        ...
        return ( ( value1 << 56 ) + ( value2 << 48 ) + ( value3 << 40 ) + ( value4 <<
                                                                            32 ) + ( value5 <<
                                                                                     24 ) + ( value6 <<
                                                                                              16 ) + ( value7 <<
                                                                                                       8 ) + ( value8 <<
    ...
    public static final int readInteger( final InputStream input )
        throws IOException
    {
