 ...
 * @version $Revision: 1.3 $ $Date: 2003-06-06 06:41:23 $
 */
    ...
    extends TestCase
{
    ...
    public void testInclusiveBase()
    {
        ...
        assertEquals( "A_VAL Str", "A_VAL", enumSet.getNameFor( BaseConstants.A_VAL ) );
        assertEquals( "B_VAL Str", "B_VAL", enumSet.getNameFor( BaseConstants.B_VAL ) );
        assertEquals( "C_VAL Str", "C_VAL", enumSet.getNameFor( BaseConstants.C_VAL ) );
        assertEquals( "D_VAL Str", "D_VAL", enumSet.getNameFor( BaseConstants.D_VAL ) );
    }
    ...
    public void testSubPatternBase()
    {
        ...
        assertEquals( "A_VAL Str", "A_V", enumSet.getNameFor( BaseConstants.A_VAL ) );
        assertEquals( "B_VAL Str", "B_V", enumSet.getNameFor( BaseConstants.B_VAL ) );
        assertEquals( "C_VAL Str", "C_V", enumSet.getNameFor( BaseConstants.C_VAL ) );
        assertEquals( "D_VAL Str", "D_V", enumSet.getNameFor( BaseConstants.D_VAL ) );
    }
    ...
    public void testInclusiveSuper()
    {
        ...
        assertEquals( "E_VAL Str", "E_VAL", enumSet.getNameFor( SuperConstants.E_VAL ) );
        assertEquals( "F_VAL Str", "F_VAL", enumSet.getNameFor( SuperConstants.F_VAL ) );
        assertEquals( "SOME_CONST Str", "SOME_CONST", enumSet.getNameFor( SuperConstants.SOME_CONST ) );
        assertEquals( "ANOTHER_CONST Str", "ANOTHER_CONST", enumSet.getNameFor( SuperConstants.ANOTHER_CONST ) );
   }
    ...
    public void testSubPatternSuper()
    {
        ...
        assertEquals( "E_VAL Str", "E_V", enumSet.getNameFor( SuperConstants.E_VAL ) );
        assertEquals( "F_VAL Str", "F_V", enumSet.getNameFor( SuperConstants.F_VAL ) );
    }
