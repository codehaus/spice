    ...
    extends TestCase
{
        ...
        throws Exception
    {
        final byte[] bytes = IOUtil.toByteArray(
            new MockInputStream( DATA_4_ELEMENTS ) );
        assertEqualArrays( DATA_4_ELEMENTS, bytes );
    }
    ...
    {
        final byte[] bytes = IOUtil.toByteArray(
            new MockInputStream( DATA_4_ELEMENTS ), 2 );
        assertEqualArrays( DATA_4_ELEMENTS, bytes );
    }
    ...
    {
        final byte[] bytes = IOUtil.toByteArray(
            new MockInputStream( DATA_4_ELEMENTS ), 20 );
        assertEqualArrays( DATA_4_ELEMENTS, bytes );
    }
        ...
        throws Exception
    {
        final MockInputStream input = new MockInputStream( DATA_4_ELEMENTS );
        final byte[] bytes = IOUtil.toByteArray(
            new InputStreamReader( input ), 20 );
        assertEqualArrays( DATA_4_ELEMENTS, bytes );
    }
