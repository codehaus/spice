 ...
 * create the DefaultParameters, associate parameters and then invoke {@link
 * #makeReadOnly()} before passing the Parameters to the client component.
 *
 * @author Peter Donald
...
{
    /**
     * Constant for separator between parameters and child parameters.
     */
    ...
    /**
     * Flag indicating whether resource has been made read-only yet.
     */
    ...
    /**
     * The child parameters objects created from with parameters object.
     */
        ...
        throws ParameterException
    {
        ...
        catch( final NumberFormatException nfe )
        {
            ...
            final String message =
                "Unable to parse parameter named " +
                prefixedName +
                " with value '" + value + "'";
    ...
    /**
     * Return name that may be prefixed with full property name unless prefix is
     * empty.
     *
     * @param name the name
    ...
    /**
     * Check if the resource has been "frozen" and thus is read only. If
     * read-only then throw an IllegalStateException.
     *
     ...
     *
     * @return true if resource has been made read-only or frozen, false
     *         otherwise.
     */
