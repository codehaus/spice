 ...
 * @version $Revision: 1.1 $ $Date: 2003-08-31 10:37:53 $
 * @phoenix.component
    ...
    implements ConnectionManager
{
        ...
        extends PicoConnectionManager
    {
       ...
       {
            super( monitor, defaultThreadPool, soTimeout, forceShutdown, shutdownTimeout );
       }
    }
     ...
     *         {@link ConnectionManager#connect(String name, ServerSocket socket, ConnectionHandlerManager handlerManager, ThreadPool threadPool )}
     * @param soTimeout the value set for SO_TIMEOUT in milliseconds
