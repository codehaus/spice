...
/**
 * This class builds a {@link ClassLoaderSetMetaData} object from specified
 * configuration.
 *
...
public class ClassLoaderSetReader
{
    ...
    /**
     * Parse out a set of predefined classloaders from specified nodes.
     *
        ...
        throws Exception
    {
        ...
        return (ClassLoaderMetaData[])loaders.toArray(
            new ClassLoaderMetaData[ loaders.size() ] );
    }
    ...
    private FileSetMetaData[] buildFileSets( final NodeList configs )
    {
        ...
        return (FileSetMetaData[])fileSets.toArray(
            new FileSetMetaData[ fileSets.size() ] );
    }
    ...
    /**
     * Create a set of strings for ClassLoader references in a Join
     * classloader.
     *
     * @param configs the nodes to process
    ...
    /**
     * Utility class to test if attribute is unspecified (by testing if it is
