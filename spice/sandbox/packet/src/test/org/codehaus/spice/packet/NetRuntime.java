...
/**
 * @author Peter Donald
 * @version $Revision: 1.1 $ $Date: 2004-03-26 02:23:01 $
 */
public class NetRuntime
{
   ...
   public NetRuntime( final SelectableChannelEventSource source,
      ...
      throws IOException
   {
      ...
      final EventPump[] pumps =
         new EventPump[]{pump1, pump2, pump3, pump4, pump5};
      return new NetRuntime( source1,
                             bufferManager,
                             sessionManager,
                             queue2,
                             pumps );
