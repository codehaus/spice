    ...
    extends AbstractTestCase
{
        ...
        throws Exception
    {
        try
        {
            Configurator.createActionManager( "blah", "org/jcomponent/swingactions/actions.xml" );
    ...
    public void testXMLConfigurator()
        throws Exception
    {
        runManagerTest( Configurator.createActionManager( Configurator.XML, "org/jcomponent/swingactions/actions.xml" ) );
