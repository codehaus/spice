...
PROJECTS="site components/classman components/cli components/configkit components/converter components/jndikit components/loggerstore components/netserve components/salt components/threadpool components/xmlpolicy sandbox/metaclass sandbox/metaschema sandbox/nativekit sandbox/swingactions sandbox/xinvoke sandbox/xsyslog"
MULTI_PROCESS="no"
